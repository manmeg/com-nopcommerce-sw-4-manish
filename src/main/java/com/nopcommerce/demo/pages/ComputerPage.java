...
public class ComputerPage extends Utility
{
    ...
    By shoppingCart = By.xpath("//button[contains(text(),'Go to cart')]");

    By ShoopingCardMsg = By.xpath("//*[@id=\"topcartlink\"]/a/span[1]");

    By addQunty = By.xpath("//input[@class='qty-input']");
    By updatecard = By.xpath("//button[@class='button-2 update-cart-button']");
    ...
    public void firstName() {
        sendTextToElement(firstName, "Mani");
    }

    public void lastName1() {
        sendTextToElement(lastName, "Meghji");
    }

    public void emailaddress() {
        sendTextToElement(email, "mani123@gmail.com");
    }
    ...
    public void addAddress() {
        sendTextToElement(address, "29 Talbot Road");
    }

    public void addzipcode() {
        sendTextToElement(zipcode, "HA04UG");
    }

    public void addPhoneNumber() {
        sendTextToElement(phone, "07788990011");
    }
